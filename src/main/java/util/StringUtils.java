...
public class StringUtils {
    ...
    public static final String ADD_TO_CART = "INSERT INTO cart_item (product_id, cart_quantity, user_id) VALUES (?, ?, ?)";
...
//    public static final String ROLE = "role";
    ...
    public static final String ADMIN_PRODUCT_PAGE = "/admin/admin-product.jsp";
    ...
    public static final String ADMIN_ORDER_PAGE = "/admin/admin-orders.jsp";
    public static final String ABOUT_US_PAGE = "/pages/about-us.jsp";
    
    public static final String USER = "user";
    
    public static final String IMAGE_DIR_USER = "Users/macbook/Documents/javaProjects/BubblesandWhirls/src/main/webapp/resources/images/user/";
	...
	public static final String UPDATE_USER_ID= "updateUserId";
	 ...
	 public static final String GET_ALL_USER_INFO = "SELECT * FROM users";
	  ...
	  public static final String ADMIN_USER_PAGE = "/admin/admin-users.jsp";
