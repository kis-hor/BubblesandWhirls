...
//		doGet(request, response);
		...
		ProductModel productModel = new ProductModel(Integer.parseInt(productId), productName, imagePart, Integer.parseInt(productPrice), productDescription, Integer.parseInt(productInventory),productCategory);
